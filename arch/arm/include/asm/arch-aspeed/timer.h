...
#define AST_TMC_CTRL1_EN(n)		(AST_TMC_EN << AST_TMC_CTRL1_SHIFT(n))
#define AST_TMC_CTRL1_1MHZ(n)		(AST_TMC_1MHZ << AST_TMC_CTRL1_SHIFT(n))
#define AST_TMC_CTRL1_OVFINTR(n)	(AST_TMC_OVFINTR << AST_TMC_CTRL1_SHIFT(n))
#define AST_TMC_CTRL1_PWM(n)	(AST_TMC_PWM << AST_TMC_CTRL1_SHIFT(n))
 ...
 * it this just one device should be enough for now.
 */
